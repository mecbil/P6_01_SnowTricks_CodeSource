 ...
 */
final class Version20211221141558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE idusers id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE users CHANGE id idusers INT AUTO_INCREMENT NOT NULL');
